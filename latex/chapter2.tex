...
Heterogeneous computing has been a particularly active research field in more
recent work, since the widespread adoption of GPUs for general purpose
computations.
This has both included research into from a hardware perspective, studying the
most meaningful diversification axes for processors in heterogeneous systems as
well as many different programming approaches, broadly categorised into library
approaches, compiler based methods and proposed DSLs.

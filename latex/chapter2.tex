...
\subsection{Additional SSA Constraint Problems}
    ...
    Collect-all constraint problem are introduced in
    \autoref{def:collectconstr}.
    Given any constraint problem $(V,C)$, the variables $V$ can be divided into
    two sets.
...
\begin{figure}[p]
    \begin{definition}{Simple Integer Constraint Problems}{auxconstr}
        ...
        \end{align*}
    \end{definition}
    \begin{definition}{Collect-all Constraint Problems}{collectconstr}

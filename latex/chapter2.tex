...
\end{figure}
    ...
    SSA constraint problem and then demonstrates the application of it with the
    ...
    Simple loop iterators show up in LLVM IR as data flow cycles with a
    $\Phi$-instruction and an addition.
    This is expressed as a constraint problem at the top of the middle part
    {\bf(b)} of the figure.
    ...
    \begin{itemize}
        \item The step size is contant one
    ...
    required, as the data flow with the $\Phi$-instruction already implies the

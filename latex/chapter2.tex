...
\subsubsection{Data Structures for Constraint Classes}
    ...
    $R_k$ for appropriate bookkeping.
...
\subsubsection{Computational Complexity}
    ...
    The chosen data structures allow for very efficient implementations
    ...
    Therefore, the computational complexity has an exponential worst case when

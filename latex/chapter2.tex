...
\subsection{Static Single Assignment Form}
    ...
    \autoref{fig:ssaoverview} shows how SSA programs can be represented as a
    hierarchy of lists.
...
\begin{figure}[h]
    \begin{definition}{Backtracking Solution of Constraint Problems}{backtracking}
        ...
        following is satisfied for all $x\in\mathbb N^V$:
        \begin{align}
...
\end{figure}
    ...
    Note that \autoref{def:backtracking} defines the concept of a backtracking
...
\subsection{Structure of Basic SSA Constraint Problems}
    ...
    \autoref{def:conjconstr}, which were already used in the example from
...
\end{figure}
    ...
    In order to form conjunctions or disjunctions of constraint problems that
    are not defined the same set of variables, \autoref{def:constrext} is used.
    This effectively defines the constraint over a larger set of variables by
    ignoring all additional values.

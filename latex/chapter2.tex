...
\begin{enumerate}
    ...
    \item The arguments of all operations can be immediately filled in with the 
          ...
          for goto statements.
    \item Incoming edges of $\Phi$-instructions are matched with incoming values
...
\end{figure}
    ...
    Finally, \autoref{theo:theo3} shows that backtracking solutions for
    extensions of constraint problems can be constructed by simply ignoring the

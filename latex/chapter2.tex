    ...
    The research contributions of the thesis are built on a new method of
    ...
    SSA constraint problems define code structures, such as loops.
...
\end{figure}
    ...
    a method for formalising their behaviour at run time.
...
\subsection{Additional Notation}
    ...
    For a set of tuples, the function $heads$ returns the set of all the first
...
\end{figure}
    ...
    The other three member functions of \texttt{BacktrackingPart} manipulate

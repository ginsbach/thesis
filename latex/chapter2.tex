    ...
    {\bf Constraint programming}, including the research about how it relates to
    program analysis; established approaches to
    {\bf compiler analysis and auto-parallelisation} that will form the
    baselines for the evaluation; {\bf heterogeneous computing} with its many
    different programming paradigmes to overcome the specific challenges of
    emerging hardware; and lastly the diverse research landscape around
    {\bf computational idioms} and related concepts.
...
\section{Constraint Programming}
    ...
    is based on compiler intermediate representation and is independent from the
    compiler frontend.
...
\section{Heterogeneous Computing}
    ...
    Heterogeneous computing has been a particularly active research field in
    more recent work, since the widespread adoption of GPUs for general purpose
    computations.
    This has both included research into from a hardware perspective, studying
    the most meaningful diversification axes for processors in heterogeneous
    ...
    For this work, the most relevant work is on programming approaches and for
    direct comparison also the compiler based methods.

\subsection{Domain Specific Languages}

    Domain specific languages have been proposed to allow efficient programming
...
\subsection{CPU-GPU data transfer optimizations}
    ...
    analysis.
    However, this approach performs a direct translation, not optimizing the

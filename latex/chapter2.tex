...
\begin{figure}[p]
    ...
    \begin{minipage}{6cm}
        ...
        \begin{graybox}
            ...
            \end{align*}
        \end{graybox}
        \phantom{\large $\implies$ backtrack}
    \end{minipage}
    ...
    \begin{minipage}{6cm}
        ...
        \begin{graybox}
            ...
            \end{align*}
        \end{graybox}
        {\large $\implies$ yield $\{\text{phi}\mapsto9,
                                \text{update}\mapsto17,
                                \text{step}\mapsto22\}$}
    \end{minipage}
...
\end{figure}
    ...
    The original SSA constraint problem is again shown at the top of the figure.
    ...
    \autoref{theo:theo1}, \autoref{theo:theo2} and \autoref{theo:theo4} are
    used to construct a backtracking solution $(P_k[C])_{k=1\dots3}$ of the
    constraint problem.
    ...
    are determined, corresponding to {\em phi}.
    ...
    $x=(9)$ and $x=(10)$ on row further down in the figure.

    For $k=2$, the backtracking solution requires $x_2$ to form a data flow
    loop with $x_1$, and it requires it to be an $add$ instruction.

    ...
    After the algorithmic discussion, an implementation of these algorithms with
    suitable data structures is drafted and the runtime complexity is discussed.
...
\subsection{Emergence of Static Single Assignment Form}
    ...
    \Cref{ssaexample} shows many of the key features of static single assignment
...
\end{equation}
    ...
    Furthermore, many different input programs get mapped to a single,
...
\subsection{Data Flow and Control Flow}
    ...
    \Cref{def:usedvalues} and the data flow graph in \Cref{def:dfg}.
...
\end{figure}
    ...
    The control flow graph in \Cref{def:cfg} is defined using individual

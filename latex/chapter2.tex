...
\subsection{The LLVM Compiler Framework}
    ...
    However, LLVM is particular in its understanding of the intermediate
...
\subsection{LLVM Example}
    ...
    demonstrated on an example function.
    ...
    well as an unsigned integer $n$ that gives the size of the vectors.
    ...
    line $8$.
    The logic within the function is in SSA form.

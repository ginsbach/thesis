...
\section{Introduction}
    ...
    parsing and before code genereation.
...
\subsection{Basic Atomic Constraints}
    ...
    variables, as well as shallow comparison constraints.
...
\begin{figure}[h]
  ...
  \begin{tabular}{|c|c|}
    ...
    \multirow{2}{*}{$\text{\it variable}\ \text{\bf ->}\ \text{\it variable}\ \Phi\ \text{\it variable}$}
        & $(z,phi)\in I_\mathcal F\mathrel\land (y,z)\in m(CFG_\mathcal F^*)\mathrel\land$ \\
        & $\exists n: (x,z,n)\in DFG_\mathcal F\mathrel\land n=|\{y'\leq y\mid (y',z)\in m(CFG_\mathcal F^*)\}|$\\
    \hline
  \end{tabular}

    ...
    In \Cref{chapter:theory}, the underlying theory for constraint programming
    on SSA compiler intermediate representation was derived.
...
\end{figure}
    ...
    is concise, as visible in \Cref{fig:candlspec}.
    ...
    instances from the solutions, the individual atomic constraints can be
    verified one by one:
    \begin{itemize}
...
\section{Language Specification}
    ...
    underlying theory from \Cref{chapter:theory}.
...
\end{figure}
    ...
    \noindent
    Furthermore, \Cref{fig:candlspec} already demonstrated that logical
...
\end{figure}
    ...
    Based on the model from \Cref{chapter:theory}, CAnDL provides a wide
...
\subsection{Modularity}
    ...
    In the first listing, a {\it formula} for the addition of two values is
...
\end{figure}
    ...
    This example can now to extended to show how {\it collect} can be used to
    ...
    constrainted to be equal to $S_1$ and with the second one in lines 4-5, it
    ...
    not because its contents are necessarily of interest themselves.

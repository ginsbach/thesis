...
\subsection{Expressing Larger Structures}
    ...
    These form a standard library that enables higher-level programming
    within CAnDL.
    This section gives an overview of how some of these standard building
    blocks are defined.

    \Cref{fig:CAnDLSESE} gives the specification of single entry single exit
    (SESE) regions.
    Such regions are spanned by variables {\tt begin} and {\tt end}, with an

...
\centering
\vspace{-1em}
\begin{lstlisting}[language=MyCpp,basicstyle=\small\ttfamily,
...
\begin{lstlisting}[language=CAnDL,
                   numbers=none,framexleftmargin=0pt,xleftmargin=0pt,
                   captionpos=t,title=
   {{\bf(e)} {} Validating the first solution:}]
( opcode{%4} = call
∧ {@sqrt} = {%4}.args[0]
...
\begin{lstlisting}[language=CAnDL,
                   numbers=none,framexleftmargin=0pt,xleftmargin=0pt,
                   captionpos=t,title=
   {{\bf(f)} {} Validating the second solution:}]
( opcode{%6} = call
∧ {@sqrt} = {%6}.args[0]
∧ function_name{@sqrt} = sqrt
∧ {%5} = {%4}.args[1]
...
\begin{lstlisting}[language=MyCpp,captionpos=t,title=
   {{\bf(g)} {} Complementing C++ transformation code:}]
using namespace std;

...
\subsection{Constraint Programming for Program Analysis}
    ...
    problems.
    The hybrid nature allows the system to also validate program transformation
    that significantly modify the control flow, e.g.\ loop unswitching.
    However, it cannot dicover transformation opportunities, only verify them
    ...
    \citet{Zhao:2012:FLI:2103656.2103709} builds a model of LLVM IR for such
    solvers.

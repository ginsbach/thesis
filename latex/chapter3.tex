...
\subsection{Delarative Programming Languages for Program Analysis}
    ...
    Due to the focus on Pascal, it remain unclear how well the proposed concepts
    translate to complex C++ code with pointer calculations.
...
\subsection{Compilation with the Polyhedral Model}
    ...
    The polyhedral model \citep{Karp:1967:OCU:321406.321418} is a well
    established approach for modeling and analysing data dependencies to enable

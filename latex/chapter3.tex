...
\section{Computational Idioms}
    ...
    The concrete concepts are partially overlapping and sometimes vague.
...
\subsection{Higher-Order Functions}
    ...
    compiler detection.
    \Cref{chapter:reductions} studies the class of Complex Reduction and
...
\subsection{Berkeley Parallel Dwarfs}
    ...
    computations (stencils) are essential idioms in \Cref{chapter:idioms}.

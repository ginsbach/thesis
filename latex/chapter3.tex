...
\subsection{Algorithmic Skeletons}
    ...
    As opposed to the higher-order functions from functional programming, and
    similarly to the Berkeley Dwarfs, the definitions for algorithmic skeletons
    are informal and not intended for automated reasoning.
    They are however heavily inspired by higher-order functions and similarly
    describe the algorithmic structure of computations.

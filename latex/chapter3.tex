...
\section{Constraint Programming}
    ...
    Constraint programming and its use for program analysis is well-documented
    in the literature.
    Previous work covers security and formal verification,but also more
    compiler-centric dataflow analysis and type inference.

    For this research, constraint programming is most interesting within the
    context of research fields such as model checking, SMT solvers, and theorem
    proving.
    However, other important background material for this thesis comes from
    the programming language design community around declarative programming
    languages.
    The prolog community particularly stands out.

    The fields vary greatly in their interests and approaches, but
    the underlying challenges are often similar, especially performance and

...
\end{figure}
    ...
    This is an overapproximation of the control dependence graph that guarantees
    all relevant control flow is retained when flushing the graph in
    reverse direction from the result of a computation.
    This information is required for isolating the kernel to implement it as a
    separate function.

...
\subsection{Benchmarks and Platform}
    ...
    This was a 64 core machine with four AMD Opteron(tm) 6376 processors and
...
\multirow{12}{*}{\bf Rodinia}
 ...
 & nn\\[-2.4mm]
 & nw\\[-2.4mm]
 & particlefilter\\[-2.4mm]
 & pathfinder\\[-2.4mm]
 & srad\\[-2.4mm]
 & streamcluster\\
\hline
\end{tabular}
\caption{Overview of the 40 individual benchmark programs, grouped into three
         suites.}
  ...
  \centering
    \begin{tikzpicture}
      \begin{axis}[ybar=0.0, ymajorgrids, xtick style={transparent}, xtick=data,legend style={font=\small},
                   xticklabel pos=upper, bar width=.25cm,
                   ymin=0, ymax=13, ytick={0,2,4,6,8,10,12},
                   symbolic x coords={BT,CG,DC,EP,FT,IS,LU,MG,SP,UA},
                   xticklabel style={rotate=0},
                   width=\textwidth, height=5.5cm, legend style={at={(0.5,0.98)},anchor=north}]
  ...
  \centering
    \begin{tikzpicture}
      \begin{axis}[ybar=0.0, ymajorgrids, xtick style={transparent}, xtick=data,legend style={font=\small},
                   ...
                   width=\textwidth, height=5.5cm, legend style={at={(0.98,0.98)},anchor=north east}]
  ...
  \centering
    \begin{tikzpicture}
      \begin{axis}[ybar=0.0, ymajorgrids, xtick style={transparent}, xtick=data,legend style={font=\small},
                   ...
                   xticklabel style={rotate=90},
                   width=\textwidth, height=5.5cm, legend style={at={(0.02,0.98)},anchor=north west}]
  ...
  \centering
    \begin{tikzpicture}
      \begin{axis}[ybar stacked, ymajorgrids, xtick style={transparent}, xtick=data, legend style={font=\small},
                   ...
                   symbolic x coords={BT,CG,DC,EP,FT,IS,LU,MG,SP,UA},
                   xticklabel style={rotate=0},
                   width=\textwidth, height=5.5cm, legend pos=north west]
...
\begin{figure}[p]
    ...
    \begin{tikzpicture}
      \begin{axis}[ybar stacked, ymajorgrids, xtick style={transparent}, xtick=data, legend style={font=\small},
                   ...
                   symbolic x coords={bfs,cutcp,histo,lbm,mri-gridding,mri-q,sad,sgemm,spmv,stencil,tpacf},
                   xticklabel style={rotate=90},
                   width=\textwidth, height=5.5cm, legend pos=north east]

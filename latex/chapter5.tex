    ...
    it explores the complexity to which CAnDL can be driven, capturing broader
    computational concepts than were demonstrated previously.

    The goal of this chapter is to take abstract algorithmic concepts that are
    ...
    The CAnDL specifications are used to build a prototype compiler that
...
\section{Specification of Idioms in CAnDL}
\label{sec:idioms}

    The specification of computational idioms in CAnDL requires a careful

    ...
    operators, but they also feature prominently in other computational idioms,
    such as stencil codes.
...
\section{Introduction}
    ...
    however, is not inhibited by indirect memory accesses.
    \Cref{chapter:candl} already used this approach to implement
    the constraint programming language CAnDL, which can also recognise

...
\section{Introduction}
    ...
    Nevertheless, to illustrate the potential performance of the scheme, it uses
...
\end{figure}
    ...
    This was because these reductions use the functions ``\texttt{fmin}'' and
    ``\texttt{fmax}'', which our system recognised as pure, but ICC did not.

...
\subsection{Discovery}
    ...
    Neither ICC nor Polly were able to detect this reduction.
...
\end{figure}
    ...
    Histogram reductions are rarer than scalar reductions.
    ...
    program.
    Another interesting examples was tpacf from the Parboil benchmarks.
    In this histogram reduction, the histogram index kernel function contains a
    binary search .
    On the other hand, the performance bottleneck of ``IS'' is a plain histogram
  ...
  \centering
    \begin{tikzpicture}
      \begin{axis}[ybar stacked, ymajorgrids, xtick style={transparent}, xtick=data, legend style={font=\small},
                   ...
                   symbolic x coords={BT,CG,DC,EP,FT,IS,LU,MG,SP,UA},
                   xticklabel style={rotate=0},
                   width=\textwidth, height=5.56230589875cm, legend pos=north west]
...
\begin{figure}[p]
    ...
    \begin{tikzpicture}
      \begin{axis}[ybar stacked, ymajorgrids, xtick style={transparent}, xtick=data, legend style={font=\small},
                   ...
                   symbolic x coords={bfs,cutcp,histo,lbm,mri-gridding,mri-q,sad,sgemm,spmv,stencil,tpacf},
                   xticklabel style={rotate=90},
                   width=\textwidth, height=5.56230589875cm, legend pos=north east]
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \begin{axis}[ybar, ymode=log, log ticks with fixed point, legend style={font=\small},
                 ...
                 ylabel={speedup vs sequential baseline},
                 xticklabel style={rotate=0},
                 width=0.75\textwidth, height=6cm, legend pos=north west]
      \addplot [fill=lightgray!80!white] table[x=benchmark,y=parallel version]{\ParallelisationData};
      \addplot [fill=black!80!white] table[x=benchmark,y=reduction parallelism]{\ParallelisationData};
      \legend{original parallel version, reduction parallelism}
    \end{axis}

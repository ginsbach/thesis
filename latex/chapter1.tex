    ...
    While the detection of higher level structures in compilers has been
    investigated before, the established approaches cannot scale to what this
    challenge requires.
    This is  because syntactic matching on programming languages has become
...
\section{Structure of the Thesis}
    ...
    (IDL) and uses it to specify algorithmic concepts that go beyond
    traditional compiler analysis: stencil computations, complex reductions and
    histograms as well as sparse and dense linear algebra.

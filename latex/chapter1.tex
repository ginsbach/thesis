...
\section{Host Compilers and Kernel Compilers}
    ...
    {\em Host compilers} translate full programs written in
    {\em host languages},
    such as the previously mentioned C/C++, Fortran and Java, while
    {\em kernel compilers} handle small computational kernels that are expressed
    in dedicated domain-specific programming languages.

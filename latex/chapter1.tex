\section{The Emergence of Heterogeneous Computing}
    ...
    every two years, and this enabled processor clock frequencies to rise
    proportionally, while maintaining similar power consumption.
    This enabled continual hardware improvements that were driven primarily by
    ...
    The fundamental contract between software and hardware - the instruction set
    architectures of mainstream processors - evolved gradually and with few
...
\subsection{Via Multi-Processing to Heterogeneous Compute}
    ...
    Scaling single core processors became unviable, and processor designer
    instead shifted to increasing core counts.

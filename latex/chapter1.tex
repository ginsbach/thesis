    ...
    It may appear obvious that e.g.\ a full C++ compiler cannot be provided for
    a typical graphics processor -- after all, most graphics processors have
    ...
    language. Using this classification, the compiler can then translate the
    code into a more specialized domain and apply the already developed domain
    specific techniques -- in the simplest case by merely linking to a library

\section{Heterogeneous Computing}
    ...
    stable.
    This resulted in ever more powerful machines with rising clock frequencies,
    capable of running increasingly complex applications.

    These physics-driven advances in hardware design had major implications also
...
\subsection{From Homogeneous Multi-Processing to Heterogeneous Compute}
    ...
    Despite immenense progress in the field, it remains an area

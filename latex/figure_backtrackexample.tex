...
\begin{minipage}[t]{6cm}
    ...
    \begin{graybox}
        ...
        \vspace{-0.5em}
        \begin{align*}
            B_1[C](M)={}&\textit{heads}(DFG_\mathcal{F}^*)\\
                \mathrel\cap{}&\textit{heads}(\textit{rev}(DFG_\mathcal{F}^*))\\
                \mathrel\cap{}&\textit{heads}(\textit{select}(\textit{phi},I_\mathcal{F}))
        \end{align*}
    \end{graybox}
    \vspace{-0.75em}
    ...
    \begin{graybox}
        ...
        \begin{align*}
            B_2[C]&(M,x)=\\
                            {}&\textit{heads}(\textit{select}(\textit{add},I_\mathcal{F}))\\
                \mathrel\cap{}&\textit{heads}(\textit{select}(x_1,DFG_\mathcal{F}^*))\\
                \mathrel\cap{}&\textit{heads}(\textit{rev}(DFG_\mathcal{F}^*))\\
                \mathrel\cap{}&\textit{heads}(\textit{select}(x_1,\textit{rev}(DFG_\mathcal{F}^*)))
        \end{align*}
    \end{graybox}
    \vspace{-0.75em}
    \phantom{\Huge \rotatebox[origin=c]{330}{$\downarrow$}{}}
    ...
    \begin{graybox}
        ...
        \vspace{-0.5em}
        \begin{align*}
            B_3[C]&(M,x)=\textit{select}(1,C_\mathcal{F})\\
                \mathrel\cap{}&\textit{heads}(\textit{select}(x_2,\textit{rev}(DFG_\mathcal{F}^*)))
        \end{align*}
    \end{graybox}
    \vspace{-0.75em}
    \phantom{\Huge \rotatebox[origin=c]{330}{$\downarrow$}{}}

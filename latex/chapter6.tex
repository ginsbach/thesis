    ...
    with a different syntax -- this chapter capturies broader computational
...
\section{Introduction}
    ...
    Effectively rewrites are required despite the functional portability.
    ...
    Hardware becomes increasingly heterogeneous, most recently with the
    development of neural network accelerators such as the Google TPU in
    \citet{jouppi2017datacenter}).
    ...
    The idioms are formulated using IDL, which allows the concise formulation
    and fast detection in optimised LLVM IR code.

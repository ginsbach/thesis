...
\section{Introduction}
    ...
    chapter achieves an approximation of such a general-purpose system,
    utilising the knowhow that is already available and encapsulated in the
    existing interfaces as an intermediary.
    Instead of implementing code generation for several heterogeneous
    accelerators, the system maps user code to heterogeneous hardware using the

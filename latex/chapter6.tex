...
\section{Conclusion}
    ...
    This chapter developed a compiler-based approach that automatically detects
    a broad class of idioms supported by libraries or domain-specific languages
    for heterogeneous processors.
    The approach is based on the constraint-based description language IDL that
    identifies program subsets adhering to idiom specifications.
    Once detected, the idioms were mechanically translated into API calls to
    external libraries or code generated by DSL compilers.

    The approach is robust and was evaluated on C/C++ versions of two
    well-known benchmark suites: NAS and Parboil.
    It detected more stencils, sparse matrix operations and generalised
    reductions and histograms than existing approaches, and it generated fast
    code.

    ...
    computational idioms -- and formalise them as IDL specifications,
...
\section{Introduction}
    ...
    The focus of that work is on inferring post invariants based on
...
\subsection{Dense Linear Algebra}
    ...
    \texttt{DotProductForAlphaBeta} idiom.
    This extends the \texttt{DotProductFor} specification with the linear

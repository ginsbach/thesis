...
\abstract{
    ...
    and domain-specific languages, requiring expensive application rewrites
    and resulting in vendor lock-in.

    This thesis introduces a constraint programming methodology that enables the
    specification and automatic detection of algorithmic structure in
    compiler intermediate representation.
    This approach allows compilers to tackle the challenge of automatic

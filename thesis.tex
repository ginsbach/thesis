...
\lstdefinelanguage{CAnDL}{
 morekeywords = { Constraint, End, include, with, collect, for, foreach,
                  forany, unused, is, if, not, otherwise, specified},
 morecomment  = [s][\color{color_strings}\bfseries]{\{}{\}}
}

\lstdefinelanguage{IDL}{
 morekeywords = { Constraint, End, inherits, with, collect, and, or, at, as },
 morecomment  = [s][\color{color_strings}\bfseries]{\{}{\}}
}
